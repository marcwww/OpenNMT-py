...
if __name__ == '__main__':
    ...
    TEXT, LABEL, train_iter, pretrain_iter, valid_iter = \
        iters.build_iters_pretrain(fpretrain=opt.fpretrain,
                                   ftrain=opt.ftrain,
                                   fvalid=opt.fvalid,
                                   bsz=opt.batch_size, level=opt.level,
                                   min_freq=opt.min_freq,
                                   is_pretrain=opt.pretrain)
    ...
    if not opt.pretrain:
        ...
        train(pretrain_iter, valid_iter, epoch,
              model, optim, criterion, opt)
